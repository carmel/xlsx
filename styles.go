...
//
// The following shows the border styles sorted by xlsx index number:
//
...
//     1     | ----------- | 6     | ===========
//
// The following shows the shading styles sorted by xlsx index number:
//
//     Index | Style           | Index | Style
//    -------+-----------------+-------+-----------------
...
//
// The following shows the patterns styles sorted by xlsx index number:
//
//     Index | Style           | Index | Style
//    -------+-----------------+-------+-----------------
...
//    style, err := f.NewStyle(&xlsx.Style{CustomNumFmt: &exp})
...
// Documents generated by xlsx start with Calibri.
...
// These can be replicated using the following xlsx formats:
//
