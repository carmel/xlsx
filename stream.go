...
//        fmt.Println(err)
//    }
//    if err := streamWriter.SetRow("A1", []interface{}{xlsx.Cell{StyleID: styleID, Value: "Data"}},
//        xlsx.RowOpts{Height: 45, Hidden: false}); err != nil {
//        fmt.Println(err)
//    }
...
//        }
//        cell, _ := xlsx.CoordinatesToCellName(1, rowID)
...
//        xlsx.Cell{Value: 1},
//        xlsx.Cell{Value: 2},
//        xlsx.Cell{Formula: "SUM(A1,B1)"}});
//
// Set cell value and rows style for a worksheet with stream writer:
//
//    err := streamWriter.SetRow("A1", []interface{}{
//        xlsx.Cell{Value: 1}},
//        xlsx.RowOpts{StyleID: styleID, Height: 20, Hidden: false});
//
...
func (bw *bufferedWriter) Sync() (err error) {
	...
	if bw.tmp == nil {
		bw.tmp, err = ioutil.TempFile(os.TempDir(), "xlsx-")
		if err != nil {
