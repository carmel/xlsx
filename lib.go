...
func (f *File) unzipToTemp(zipFile *zip.File) (string, error) {
	tmp, err := ioutil.TempFile(os.TempDir(), "xlsx-")
	if err != nil {
		return "", err
	}
	rc, err := zipFile.Open()
...
// Example:
//
//     xlsx.SplitCellName("AK74") // return "AK", 74, nil
//
...
// Example:
//
//     xlsx.ColumnNameToNumber("AK") // returns 37, nil
//
...
// Example:
//
//     xlsx.ColumnNumberToName(37) // returns "AK", nil
//
...
// Example:
//
//    xlsx.CellNameToCoordinates("A1") // returns 1, 1, nil
//    xlsx.CellNameToCoordinates("Z3") // returns 26, 3, nil
//
...
// Example:
//
//    xlsx.CoordinatesToCellName(1, 1) // returns "A1", nil
//    xlsx.CoordinatesToCellName(1, 1, true) // returns "$A$1", nil
//
