...
//
//    formulaType, ref := xlsx.STCellFormulaTypeArray, "A3:A3"
//    err := f.SetCellFormula("Sheet1", "A3", "={1,2,\"a\",\"b\"}",
//        xlsx.FormulaOpts{Ref: &ref, Type: &formulaType})
//
...
//
//    formulaType, ref := xlsx.STCellFormulaTypeShared, "C1:C5"
...
//            return
//        }
//        formulaType := xlsx.STCellFormulaTypeDataTable
//        if err := f.SetCellFormula("Sheet1", "C2", "=SUM(Table1[[A]:[B]])",
//            xlsx.FormulaOpts{Type: &formulaType}); err != nil {
//            fmt.Println(err)
//            return
//        }
...
//
//    err := f.SetCellHyperLink("Sheet1", "A3", "https://github.com/carmel/xlsx", "External")
...
//            return
//        }
//        if err := f.SetCellRichText("Sheet1", "A1", []xlsx.RichTextRun{
//            {
//                Text: "bold",
//                Font: &xlsx.Font{
//                    Bold:   true,
...
//            return
//        }
//        style, err := f.NewStyle(&xlsx.Style{
