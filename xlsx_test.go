...
func TestSetCellHyperLink(t *testing.T) {
	...
	assert.NoError(t, f.SetCellHyperLink("Sheet1", "B19", "https://github.com/carmel/xlsx", "External"))
	// Test add first hyperlink in a work sheet.
	assert.NoError(t, f.SetCellHyperLink("Sheet2", "C1", "https://github.com/carmel/xlsx", "External"))
	...
	assert.EqualError(t, f.SetCellHyperLink("Sheet1", "A65531", "https://github.com/carmel/xlsx", "External"), ErrTotalSheetHyperlinks.Error())
	...
	err = f.SetCellHyperLink("Sheet1", "A1", "https://github.com/carmel/xlsx", "External")
	assert.EqualError(t, err, `cannot convert cell "A" to coordinates: invalid cell name "A"`)
}
...
func TestSetDeleteSheet(t *testing.T) {
	...
	t.Run("TestBook4", func(t *testing.T) {
		...
		assert.NoError(t, f.AddComment("Sheet1", "A1", "xlsx: ", "This is a comment."))
...
func prepareTestBook1() (*File, error) {
	...
	err = f.AddPicture("Sheet1", "F21", filepath.Join("test", "images", "excel.png"),
		`{"x_offset": 10, "y_offset": 10, "hyperlink": "https://github.com/carmel/xlsx", "hyperlink_type": "External", "positioning": "oneCell"}`)
	if err != nil {
		return nil, err
	}
