...
//
//     dvRange := xlsx.NewDataValidation(true)
//     dvRange.Sqref = "A7:B8"
...
//     dvRange := xlsx.NewDataValidation(true)
//     dvRange.Sqref = "A1:B2"
//     dvRange.SetRange(10, 20, xlsx.DataValidationTypeWhole, xlsx.DataValidationOperatorBetween)
//     dvRange.SetError(xlsx.DataValidationErrorStyleStop, "error title", "error body")
...
//     dvRange = xlsx.NewDataValidation(true)
//     dvRange.Sqref = "A3:B4"
//     dvRange.SetRange(10, 20, xlsx.DataValidationTypeWhole, xlsx.DataValidationOperatorGreaterThan)
